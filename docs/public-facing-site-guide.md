# Public-Facing Site Guide

The Postdoc Project site can serve two purposes at the same time:

1. a coordination space for the postdoc and collaborators while work is underway
2. a public-facing record of the postdoc research as outputs mature
...
## Sections A Live Postdoc Project May Add Or Fill In

### Postdoc Project Question

State the central question in plain language. A strong question tells readers what the project is trying to understand and what kind of evidence or output may answer it.
...
List the postdoc, mentors, collaborators, institutions, and responsibilities. Roles help readers understand the expertise behind the work and help collaborators know who to contact.

### Data And Evidence

Describe the datasets, observations, models, or sources the project uses. Link to public datasets when possible. For large shared files, point to the relevant persistent storage README or metadata note.
...
The site does not need to wait until the project is finished. During the postdoc project, use it to share:
