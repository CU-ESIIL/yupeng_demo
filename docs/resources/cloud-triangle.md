...
Postdoc projects usually move between three connected places:

- GitHub, where the postdoc keeps code, documentation, meeting notes, small configuration files, small example data, and public-facing narrative.
- Persistent storage, where the project keeps large datasets, model outputs, intermediate files, rasters, tables, and shared data products.
- JupyterHub or another compute instance, where the postdoc does active analysis, exploration, temporary processing, and interactive work.
...
If a future postdoc or collaborator needs to understand why a decision was made, GitHub should give them the trail.
...
JupyterHub, CyVerse VICE, or another compute instance is the place to work interactively. It is where the postdoc and collaborators open notebooks, test workflows, make plots, and inspect data.
