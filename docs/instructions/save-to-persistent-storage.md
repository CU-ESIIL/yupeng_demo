...
Persistent storage is the shared place for large files that should survive beyond a running compute instance. Use it for data and outputs that are important to the postdoc project but too large or too changeable for GitHub.
...
Replace the postdoc project name and username before running these commands:
...
Create folders as the project needs them:
