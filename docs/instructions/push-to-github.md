...
This rhythm keeps work visible to collaborators and prevents the postdoc project from splitting into many disconnected copies of the same repository.

## Pull The Latest Changes

In the JupyterLab Git panel, click Pull before editing. This brings in changes that other postdocs and collaborators have pushed.
...
Good postdoc project commits are small enough that someone else can understand them later.
...
Postdoc projects continue beyond a single meeting, so coordination matters.
