...
REPO_URL = "https://github.com/CU-ESIIL/Postdoc_OASIS"

SLOT_METADATA = {
    "hero": {
        "title": "Homepage hero image",
        "caption": "This image gives the Postdoc Project homepage a shared visual identity for environmental data science.",
    ...
    "group-photo": {
        "title": "Project identity image",
        "caption": "This image represents collaboration, project identity, or a real postdoc project photo.",
        "instructions": "To update: delete the current image in this folder and upload one new image. A real project photo is welcome here, but an abstract collaboration image also works.",
        "fallback": "placeholder.svg",
    },
    "repository-side": {
        "title": "Repository-side image",
        "caption": "This image represents the repository side of the postdoc project: data, code, workflows, and reproducibility.",
    ...
    "website-side": {
        ...
        "caption": "This image represents the website side of the postdoc project: summaries, maps, figures, and public communication.",
        "instructions": "To update: delete the current image in this folder and upload one new square image. Use a flat, minimal, screen-print style graphic with no text.",
        "fallback": "placeholder.svg",
    },
    "data": {
        "title": "Data image",
        "caption": "This image represents datasets, metadata, and the data sources behind the postdoc project.",
        "instructions": "To update: delete the current image in this folder and upload one new square image. Use a flat, minimal, screen-print style graphic with no text.",
        "fallback": "placeholder.svg",
    },
    "analysis": {
    ...
    "outputs": {
        "title": "Outputs image",
        "caption": "This image represents figures, synthesis products, and the final outputs shared by the postdoc project.",
        "instructions": "To update: delete the current image in this folder and upload one new square image. Use a flat, minimal, screen-print style graphic with no text.",
        "fallback": "placeholder.svg",
    },
}
...
PROCESS_METADATA = {
    "start-here": {
        "description": "This gallery displays early setup artifacts for the postdoc project.",
        "instructions": "Use this folder for kickoff notes, orientation screenshots, starter diagrams, and early planning visuals.",
    },
    "data": {
        "description": "This gallery displays data source artifacts and metadata documentation for the postdoc project.",
    ...
    "exploration": {
        "description": "This gallery displays rough exploration artifacts for the postdoc project.",
    ...
    "outputs": {
        "description": "This gallery displays emerging and final outputs from the postdoc project.",
        "instructions": "Use this folder for draft figures, polished graphics, synthesis visuals, and final output previews.",
    },
    "deliverables": {
        "description": "This gallery displays deliverable files and linked products for the postdoc project.",
